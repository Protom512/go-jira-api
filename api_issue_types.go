...
func (a *IssueTypesApiService) CreateIssueTypeAvatar(ctx context.Context, body Object, size int32, id string, localVarOptionals *IssueTypesApiCreateIssueTypeAvatarOpts) (Avatar, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
