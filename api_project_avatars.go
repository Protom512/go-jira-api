...
func (a *ProjectAvatarsApiService) CreateProjectAvatar(ctx context.Context, body Object, projectIdOrKey string, localVarOptionals *ProjectAvatarsApiCreateProjectAvatarOpts) (Avatar, *http.Response, error) {
	var (
...
@return Object
*/
func (a *ProjectAvatarsApiService) UpdateProjectAvatar(ctx context.Context, body Avatar, projectIdOrKey string) (Object, *http.Response, error) {
	var (
