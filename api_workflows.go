...
/*
WorkflowsApiService Create workflow
...
@return WorkflowIDs
*/
func (a *WorkflowsApiService) CreateWorkflow(ctx context.Context, body CreateWorkflowDetails) (WorkflowIDs, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue WorkflowIDs
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rest/api/3/workflow"
...
/*
WorkflowsApiService Delete inactive workflow
...
*/
func (a *WorkflowsApiService) DeleteInactiveWorkflow(ctx context.Context, entityId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rest/api/3/workflow/{entityId}"
...
/*
WorkflowsApiService Get all workflows
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WorkflowsApiGetAllWorkflowsOpts - Optional Parameters:
     * @param "WorkflowName" (optional.String) -  The name of the workflow to be returned. Only one workflow can be specified.
@return []DeprecatedWorkflow
*/

type WorkflowsApiGetAllWorkflowsOpts struct {
    WorkflowName optional.String
}

func (a *WorkflowsApiService) GetAllWorkflows(ctx context.Context, localVarOptionals *WorkflowsApiGetAllWorkflowsOpts) ([]DeprecatedWorkflow, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []DeprecatedWorkflow
	)
...
/*
WorkflowsApiService Get workflows paginated
Returns a [paginated](#pagination) list of published classic workflows. When workflow names are specified, details of those workflows are returned. Otherwise, all published classic workflows are returned.  This operation does not return next-gen workflows.  **[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WorkflowsApiGetWorkflowsPaginatedOpts - Optional Parameters:
     ...
     * @param "WorkflowName" (optional.Interface of []string) -  The name of a workflow to return. To include multiple workflows, provide an ampersand-separated list. For example, &#x60;workflowName&#x3D;name1&amp;workflowName&#x3D;name2&#x60;.
...
type WorkflowsApiGetWorkflowsPaginatedOpts struct {
    StartAt optional.Int64
    MaxResults optional.Int32
    WorkflowName optional.Interface
    Expand optional.String
}

func (a *WorkflowsApiService) GetWorkflowsPaginated(ctx context.Context, localVarOptionals *WorkflowsApiGetWorkflowsPaginatedOpts) (PageBeanWorkflow, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PageBeanWorkflow
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rest/api/3/workflow/search"
	...
	if localVarOptionals != nil && localVarOptionals.WorkflowName.IsSet() {
		localVarQueryParams.Add("workflowName", parameterToString(localVarOptionals.WorkflowName.Value(), "multi"))
	}
