...
type ComponentWithIssueCount struct {
	...
	Lead *AllOfComponentWithIssueCountLead `json:"lead,omitempty"`
	...
	Assignee *AllOfComponentWithIssueCountAssignee `json:"assignee,omitempty"`
	// The user assigned to issues created with this component, when `assigneeType` does not identify a valid assignee.
	RealAssignee *AllOfComponentWithIssueCountRealAssignee `json:"realAssignee,omitempty"`
