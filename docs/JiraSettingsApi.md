...
# **GetAdvancedSettings**
> []ApplicationProperty GetAdvancedSettings(ctx, )
...
> []ApplicationProperty GetApplicationProperty(ctx, optional)
 ...
 **optional** | ***JiraSettingsApiGetApplicationPropertyOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a JiraSettingsApiGetApplicationPropertyOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **key** | **optional.String**| The key of the application property. | 
 **permissionLevel** | **optional.String**| The permission level of all items being returned in the list. | 
 **keyFilter** | **optional.String**| When a &#x60;key&#x60; isn&#x27;t provided, this filters the list of results by the application property &#x60;key&#x60; using a regular expression. For example, using &#x60;jira.lf.*&#x60; will return all application properties with keys that start with *jira.lf.*. | 
...
> ApplicationProperty SetApplicationProperty(ctx, body, id)
