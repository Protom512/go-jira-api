...
**AvatarUrls** | [***AllOfUserAvatarUrls**](AllOfUserAvatarUrls.md) | The avatars of the user. | [optional] [default to null]
...
**Groups** | [***AllOfUserGroups**](AllOfUserGroups.md) | The groups that the user belongs to. | [optional] [default to null]
**ApplicationRoles** | [***AllOfUserApplicationRoles**](AllOfUserApplicationRoles.md) | The application roles the user is assigned to. | [optional] [default to null]
