...
> BulkDeleteIssueProperty(ctx, body, propertyKey)
...
> BulkSetIssueProperty(ctx, body, propertyKey)
...
> BulkSetIssuesProperties(ctx, body)
...
# **DeleteIssueProperty**
> DeleteIssueProperty(ctx, issueIdOrKey, propertyKey)
...
# **GetIssueProperty**
> EntityProperty GetIssueProperty(ctx, issueIdOrKey, propertyKey)
Get issue property
...
> PropertyKeys GetIssuePropertyKeys(ctx, issueIdOrKey)
...
# **SetIssueProperty**
> Object SetIssueProperty(ctx, body, issueIdOrKey, propertyKey)
Set issue property
