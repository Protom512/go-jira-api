...
# **AnalyseExpression**
> JiraExpressionsAnalysis AnalyseExpression(ctx, body, optional)
...
> JiraExpressionResult EvaluateJiraExpression(ctx, body, optional)
 ...
 **optional** | ***JiraExpressionsApiEvaluateJiraExpressionOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a JiraExpressionsApiEvaluateJiraExpressionOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
