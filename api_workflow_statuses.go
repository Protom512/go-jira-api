...
/*
WorkflowStatusesApiService Get status
...
@return ModelMap
*/
func (a *WorkflowStatusesApiService) GetStatus(ctx context.Context, idOrName string) (ModelMap, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rest/api/3/status/{idOrName}"
...
/*
WorkflowStatusesApiService Get all statuses
...
@return []ModelMap
*/
func (a *WorkflowStatusesApiService) GetStatuses(ctx context.Context) ([]ModelMap, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rest/api/3/status"
