...
type ProjectComponent struct {
	...
	Lead *AllOfProjectComponentLead `json:"lead,omitempty"`
	...
	Assignee *AllOfProjectComponentAssignee `json:"assignee,omitempty"`
	...
	RealAssignee *AllOfProjectComponentRealAssignee `json:"realAssignee,omitempty"`
