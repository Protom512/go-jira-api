...
@return Group
*/
func (a *GroupsApiService) AddUserToGroup(ctx context.Context, body ModelMap, groupname string) (Group, *http.Response, error) {
	var (
 ...
 * @param optional nil or *GroupsApiFindGroupsOpts - Optional Parameters:
     ...
     * @param "Exclude" (optional.Interface of []string) -  A group to exclude from the result. To exclude multiple groups, provide an ampersand-separated list. For example, &#x60;exclude&#x3D;group1&amp;exclude&#x3D;group2&#x60;.
...
func (a *GroupsApiService) GetGroup(ctx context.Context, groupname string, localVarOptionals *GroupsApiGetGroupOpts) (Group, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *GroupsApiService) GetUsersFromGroup(ctx context.Context, groupname string, localVarOptionals *GroupsApiGetUsersFromGroupOpts) (PageBeanUserDetails, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *GroupsApiRemoveGroupOpts - Optional Parameters:
     * @param "SwapGroup" (optional.String) -  The group to transfer restrictions to. Only comments and worklogs are transferred. If restrictions are not transferred, comments and worklogs are inaccessible after the deletion.
...
func (a *GroupsApiService) RemoveGroup(ctx context.Context, groupname string, localVarOptionals *GroupsApiRemoveGroupOpts) (*http.Response, error) {
	var (
...
func (a *GroupsApiService) RemoveUserFromGroup(ctx context.Context, groupname string, accountId string, localVarOptionals *GroupsApiRemoveUserFromGroupOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
