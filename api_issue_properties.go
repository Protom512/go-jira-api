...
/*
IssuePropertiesApiService Bulk set issues properties
...
*/
func (a *IssuePropertiesApiService) BulkSetIssuesProperties(ctx context.Context, body IssueEntityProperties) (*http.Response, error) {
	var (
